...
public class SideSlabBlocks {
    ...
    public static final Map<Supplier<Block>, Supplier<Block>> SLAB_TO_SIDE_SLAB = new HashMap<>();
    ...
    private static void register(String name, Block base) {
        Supplier<Block> sideSlab = BLOCKS.registerBlock(name + "_side_slab",
                () -> new SideSlabBlock(BlockBehaviour.Properties.ofFullCopy(base)));
        SLAB_TO_SIDE_SLAB.put(() -> base, sideSlab);
    }
